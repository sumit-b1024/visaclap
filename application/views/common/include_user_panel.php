	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				...
				<span class="symbol symbol-lg-15 symbol-25 symbol-light-success">
					<span class="symbol-label font-size-h1 font-weight-bold">
						<?= toPropercase($userdata['user_name'][0]); ?>
					</span>
				</span>
			</div>
			...
			<div class="d-flex flex-column">
				<a href="javascript:;" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
					<?= toPropercase($userdata['user_name']); ?>
				</a>
				...
				<div class="navi mt-2">
					...
					<a href="<?= ROOT_URL . 'account/signout'; ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
				</div>
			</div>
		</div>
		<!--end::Header-->
