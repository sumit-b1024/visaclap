...
function buttonLeft() {
  ...
  if (screen.availWidth >= 1200) {
    ...
    document.getElementById("recommended-row").scrollLeft -= 980;
...
if (index <= Math.round(bullets.length / 4) && index > 1) {
    ...
    document.getElementById("recommended-row").style.transition = "all 2s";
    document.getElementById("recommended-row").scrollLeft -= 320;
    document.getElementById("pagination-bullets-scroll").scrollLeft -= 10;
    ...
    document.getElementById("recommended-row").style.transition = "all 2s";
    document.getElementById("recommended-row").scrollLeft -= 360;
    document.getElementById("pagination-bullets-scroll").scrollLeft -= 10;
    ...
    document.getElementById("recommended-row").style.transition = "all 2s";
    document.getElementById("recommended-row").scrollLeft -= 540;
    document.getElementById("pagination-bullets-scroll").scrollLeft -= 10;
    ...
    document.getElementById("recommended-row").style.transition = "all 2s";
    document.getElementById("recommended-row").scrollLeft -= 640;
    document.getElementById("pagination-bullets-scroll").scrollLeft -= 10;
    if (index <= Math.round(bullets.length / 1) && index > 1) {
      index--;
    }
