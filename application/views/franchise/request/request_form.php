...
.form-group .cusradio{margin-right: 10px;}
.cushr{    margin: 0 auto;
    margin-top: 10px;
    margin-bottom: 10px;}
h3 {
    font-size: 18px;
        ...
        <form name="submittravellerdata" id="submittravellerdata" class="submittravellerdata">
            ...
            <div class="col-md-12">
                        ...
                        <div class="col-md-12 display_exist_inquiry" style="display:none;">
                            <div class="form-group input-inside">
                             <label class="form-label ">Select Enquiry<span class="text-red"> *</span></label>
                             <select class="form-control  form-select wap_enquiry_id" name="wap_enquiry_id" id="wap_enquiry_id" style="width:100%;">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group input-inside">
                                ...
                                <select class="form-control s_description form-select" name="s_description">
                        ...
                        <div class="col-sm-12 col-md-12 mb-1">
                            <div class="form-group input-inside">
                                ...
                                <select class="form-control enquiry_staff_id form-select"  name="enquiry_staff_id" value="<?= $enquiry->intersted_country ?>" data-placeholder="Select Staff">
         ...
         <div class="row"><div class="fovsrm-group ">
           ...
           <div class="row visa_fields cmn-blk">
...
var mailselectc = $('.wap_enquiry_id');
      ...
      $.ajax({
        ...
        if(res.formdata != ""){
         ...
         for(let i = 1; i <= total_no_of_travellers; i++){
                ...
                displayfields += '<div class="alert alert-dark" role="alert"><b>Enter Details for Applicant     #'+i+'</b>'+remove+'</div>';
                ...
                $.each(res.formdata, function (keys, fields) {
                 ...
                 displayfields += '<input type="hidden" name="label_id[]" value="'+capitalizeFirstLetter(keys)+'" />';
                  ...
                  displayfields += '<div class="col-sm-4 col-md-4 input-inside mb-1">';
                  displayfields += '<div class="form-group"><label class="form-label">'+field.label_name+'</label><br/>';
                  ...
                  if(field.field_type == 'text'){
                     ...
                     displayfields += '<div class="row">';
                     displayfields += '<div class=" col-md-6 col-sm-6 input-inside mb-1"><select class="form-select" name="fields['+submitdata+']['+informtitle+']['+namefieldlabel+'][month]['+genderval+']"><option value="">Month</option>';
                     $.each(months, function (key, month) {
                        displayfields += '<option value='+month+'>'+month+'</option>';     
                    });
                     displayfields += '</select></div>';
                     displayfields += '<div class=" col-md-3 col-sm-3 input-inside mb-1"><select class="form-select" name="fields['+submitdata+']['+informtitle+']['+namefieldlabel+'][day]['+genderval+']"><option value="">Day</option>';
                     $.each(days, function (key, day) {
                        displayfields += '<option value='+day+'>'+day+'</option>';     
                    });
                     displayfields += '</select></div>';
                     displayfields += '<div class=" col-md-3 col-sm-3 input-inside mb-1"><select class="form-select" name="fields['+submitdata+']['+informtitle+']['+namefieldlabel+'][year]['+genderval+']" ><option  value='+i+'>Year</option>';
                 ...
                 displayfields += '<textarea class="form-control input-inside mb-1" name="fields['+submitdata+']['+informtitle+']['+namefieldlabel+']['+genderval+']" ></textarea>';
                ...
                if(fields[key].list_value.length > 0){
                  $.each(fields[key].list_value, function (key, list_value) {
                    displayfields += '<input type="radio" name="fields['+submitdata+']['+informtitle+']['+namefieldlabel+']['+genderval+']" id="'+list_value.name+'_'+genderval+'" value="'+list_value.name+'"><label class="cusradio" for="'+list_value.name+'_'+genderval+'">'+list_value.name+'</label>';     
                }); 
               }    
             ...
             displayfields += '</div></div>';    
                 ...
                 displayfields += '<hr class="cushr"></div>';
                 displayfields += '</div>';    
                 displayfields += '</div>';
             });
                 //displayfields += '</div>';
           ...
           // displayfields += '<div class="card">';
            ...
            displayfields += '<div class="card-body"><button type="submit" class="col-1 box-btn fill_primary enquiry_btn submit_btn pull_right" id="submit_btn">Submit</button></div>';
            displayfields += '</form>';    
...
$('.i_country').on('change',function(){
      ...
      var gid =  '<?php echo $this->uri->segment('6'); ?>';
      var visaid =  '<?php echo $this->uri->segment('7'); ?>';
      var visaserviceid =  '<?php echo $this->uri->segment('8'); ?>';
      var company =  '<?php echo $this->uri->segment('9'); ?>';
     ...
     formdata.append('visaservice', visaserviceid);
     formdata.append('intersted_country', destinationcountry);
     formdata.append('companycheck', company);
