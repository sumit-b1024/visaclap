               ...
               <div class="row">
                 ...
                 { ?>
                    ...
                    <div class="col-md-3">
                       ...
                       <select class="form-control select2-show-search form-select country" name="country" id="country" data-placeholder="Choose country">
                          <option></option>
                          <?php
                    ...
                    <div class="col-md-3">
                      ...
                      <select class="form-control select2-show-search form-select city" name="city" id="city" data-placeholder="Choose city">
                         <option></option>
                         <?php
                 ...
                 { ?>
                  ...
                  <br/>
                      ...
                      <div class="row">  
                      <div class="col-md-6">
                        <label class="form-label">Wats Included</label>
                        <div class="row include_div" style="margin-top: 10px !important;">
                           <div class="col-sm-6 col-md-6">
                              
                              <input type="text" class="form-control detail" name="include[]" id="include_1">
                           </div>
                       ...
                       <div class="col-md-6">
                        <label class="form-label">Wats Not Included</label>
                        <div class="row notinclude_div" style="margin-top: 10px !important;">
                           <div class="col-sm-6 col-md-6">
                              
                              <input type="text" class="form-control detail" name="notinclude[]" id="notinclude_1">
                           </div>

                           <div class="col-sm-1 col-md-1">
                              <button type="button" class="btn btn-danger remove_notinclude_row"><i class="fa fa-minus"></i></button>
                           </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-4 col-md-4">
                           <button type="button" class="btn btn-success add_more_notinclude" id="add_more_notinclude">Add More</button>
                        </div>
                     </div>
                      </div>
                   </div>  
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      $(document).on('click','#add_more_row',function(){
               var numberIncr = 0;
               var total_tr = $('.include_div').length + 1;
               var $tr=$(".include_div").last();
               var $clone=$tr.clone();
               $clone.find('.include').val('');
               $clone.find('.include').attr('id','include_'+total_tr);
               $tr.after($clone);
               
            });
      $(document).on('click','#add_more_notinclude',function(){
               var numberIncr = 0;
               var total_tr = $('.notinclude_div').length + 1;
               var $tr=$(".notinclude_div").last();
               var $clone=$tr.clone();
               $clone.find('.notinclude').val('');
               $clone.find('.notinclude').attr('id','notinclude_'+total_tr);
               $tr.after($clone);
               
            });
$(document).on('click', '.remove_row', function() {
            var total_tr = $('.include_div').length;
            if(total_tr > 1) 
            {
               jQuery(this).closest('.include_div').remove();
               return false;
            }
         });
   $(document).on('click', '.remove_notinclude_row', function() {
            var total_tr = $('.notinclude_div').length;
            if(total_tr > 1) 
            {
               jQuery(this).closest('.notinclude_div').remove();
               return false;
            }
         });
