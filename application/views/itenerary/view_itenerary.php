      ...
      <div class="card">
           ...
           <div class="row">
            ...
            <div class="col-sm-5 col-md-5">
             <div class="form-group input-inside">
               ...
               <select class="country_id form-select select2-show-search" name="country_id" id="country_id" data-placeholder="Select Country">
         ...
         <div class="col-sm-5 col-md-5">
          <div class="form-group input-inside">
           ...
           <select class="city form-select" name="city" id="city" data-placeholder="Select City">
            <option value="">Select City</option>
           </select>
        </div>
     </div>

     <div class="col-sm-2 col-md-2" style="margin-top: 27px;">
...
<div class="card">
   ...
   <div class="card-header">
      <div class="row">
         <div class="col-12" >
            <a href="<?= base_url(). 'itenerary/add'; ?>" class="box-btn fill_primary pull-right" style="margin: 0 2px;">
               <i class="fa fa-plus"></i> Add 
            </a>
          <!--   <button class="box-btn fill_primary pull-right generate_travel_itenary" data-bs-effect="effect-rotate-left" style="margin: 0 2px;">
      ...
      <div class="modal-dialog " role="document">
         <div class="modal-content modal-content-demo">
            <form class="store_itineraty_form_data">
               <div class="modal-header">
                  <h6 class="modal-title">Generate Autometic Itinerary</h6><button type="button" aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
               </div>

               <div class="modal-body follow_up_body">
                  <div class="form-group input-inside">
                     <label class="form-label ">Itinerary Name <span class="text-red"> *</span></label>
                  ...
                  <div class="form-group input-inside">
                     <label class="form-label">Select Star</label><br/>
               ...
               <div class="modal-footer">
                  <button type="button" class="box-btn fil_gray btn_cancel" data-bs-dismiss="modal">Close</button>
                  <button type="submit" class="box-btn fill_primary generate_itinerary" >Submit</button>
               </div>
            </form>
         </div>
      </div>
