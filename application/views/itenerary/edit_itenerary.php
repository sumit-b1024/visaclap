...
<div class="row">
	<div class="col-md-12 col-xl-12">
		<div class="card">
			...
			<div class="card-body">
				<form class="form-horizontal add_update_itenerary" method="post">
					<div class="row">
						<div class="col-sm-12 col-md-12">
							<div class="form-group">
								<label class="form-label"> Itinerary Name <span class="text-red">*</span></label>
								<input type="text" name="i_name" class="form-control i_name" placeholder="Enter Itinerary Name" value="<?php echo  isset($_view) && $_view->i_name ? $_view->i_name : ''; ?>">
							</div>
						</div>
					</div>
					<div class="row">
									...
									<?php $i++; } } else { ?>
										...
										<div class="row">
											<div class="col-sm-6 col-md-4">
												...
												<a href="<?= base_url('itenerary'); ?>" class="btn btn-danger mt-4 mb-0">Cancel</a>
					...
					<script type="text/javascript">
						function get_titles_by_cc() {
							...
							if(destination > 0 || city > 0){
								$.ajax({
									type:"POST",
									url: base_url + "itenerary/get_titles_by_cc",
						...
						$(document).ready(function(){
							...
							jQuery(document).on('click', '.remove_row', function () {
								...
								if (total_tr >= 1 && r_id == 0) {
									...
									function () {
										$.ajax({
											url: base_url + "itenerary/remove_itenerary",
											type : "POST",
											data : {
												"r_id": r_id,
											},
					...
					$(document).on('submit','.add_update_itenerary',function(e){
						...
						if($(this).valid()){
							...
							$.ajax({
								type:"POST",
								url: base_url + "itenerary/update_tenerary_data",
					...
					$('#destination').on('change',function(){
						...
						if(destination){
							$.ajax({
								type:"POST",
								url: base_url + "itenerary/get_all_cities_by_country_id",
