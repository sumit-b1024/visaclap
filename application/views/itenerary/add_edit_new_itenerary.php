					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group input-inside">
								...
								<select class="form-control select2-show-search city" name="city" id="city" data-placeholder="Select City">
									<option value=""></option>
								</select>
							</div>
						</div>
						...
						<div class="col-sm-12 col-md-12 input-inside">
							...
							<div class="row question_div" style="margin-top: 10px !important;">
								...
								<div class="col-sm-4 col-md-4" data-placeholder="Select Title">
									<p>
										<select class="form-select title" id="title_1" name="title[]"  data-placeholder="Select Title">
											<option value=""></option>
										</select>
									</p>
								</div>
						...
						<div class="row">
							<div class="col-sm-6 col-md-4 form-btns">
								...
								<a href="<?= base_url('itenerary'); ?>" class="box-btn fil_grey mt-4 mb-0">Cancel</a>
			...
			$(document).ready(function(){
				...
				$(document).on('submit','.add_update_itenerary',function(e){
					...
					if($(this).valid()){
						...
						$.ajax({
							type:"POST",
							url: base_url + "itenerary/store_tenerary_data",
							...
							success:function(res){
								...
								if(res.status == "success"){
									...
									window.location.href = base_url + 'itenerary';
