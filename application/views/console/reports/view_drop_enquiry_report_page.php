   ...
   if(!empty($fetch_enquiry_array)){
      foreach ($fetch_enquiry_array as $template )
      {
         ...
         <tr>
          <td>
             <label class="custom-control custom-checkbox-md">
               <input type="checkbox" class="custom-control-input pool_drop_td" name="process_check_box_td" id="pool_drop_td" value="<?= $template->id; ?>">
               <span class="custom-control-label"></span>
            </label>
         </td>
         <td>
     ...
     ?>
         ...
         <!--   <button href="javascript:void(0)" class="change_process_pool_status"  pool_record_id="<?= $template->id; ?>"  value="1" ><b><u>Process Pool</u></b></button>  -->
      ...
      <td><?= date('d-M-Y',strtotime($template->follow_up_date)); ?></td>
       ...
       <td>
         <div class="tbl-action-wrap">
          ...
          <button type="button" class="single-action btn-sm mr-2" title="View" id="view_pool_des" value="<?= $template->id ?>">
