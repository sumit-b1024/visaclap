        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal supplier_form" id="add-form" class="login100-form validate-form" method="post">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control country select2-show-search form-select " name="country" id="country" data-placeholder="Select Country">
                                	<option></option>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control state select2-show-search form-select city" name="city" id="city" data-placeholder="Select City">
                                	<option></option>
                                	<?php
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            <button type="submit" class="btn btn-primary mt-4 mb-0" id="submit_btn">
                                Submit
                            </button>
