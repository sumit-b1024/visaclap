                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                        ...
                        <tbody>
                            ...
                            {
                                ?>
                                <tr id="r-<?= $list->category_id; ?>">
                                    <td><?= toPropercase($list->name); ?></td>
                                    <td><?= date('d M Y H:i', $list->created_on); ?></td>
                                    <td>
                                        <a href="<?= ROOT_URL . 'settings/edit-category/' . $list->category_id; ?>" class="btn btn-icon btn-warning btn-sm mr-2" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <a href="javascript:;" data-id="<?= $list->category_id; ?>" data-table="<?= TBL_CATEGORY; ?>" data-row="category_id" class="btn btn-icon btn-danger btn-sm mr-2 delete_btn" title="Delete">
