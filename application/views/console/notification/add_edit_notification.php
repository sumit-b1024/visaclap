                ...
                <form class="form-horizontal notification_form" id="add-form" class="login100-form validate-form" method="post">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
								...
								<textarea name="description" id="description" class="form-control" placeholder="Notification"><?= isset($notifications) && !empty($notifications->description) ? $notifications->description : set_value('description'); ?></textarea>
                            </div>
                        </div> 
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            ...
                            <input type="hidden" name="id" value="<?= isset($notifications) && !empty($notifications->id) ? $notifications->id :''; ?>">
                        </div>
                    </div>
                </form>
...
function goBack() {
	var continue_to = base_url + 'notification';
...
$(document).ready(function() {
	...
	function submit_form() {
		...
		$.ajax({
			type: 'POST',
			url: base_url + 'notification/ajax_add_notification',
