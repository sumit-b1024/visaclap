					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group input-inside">
								...
								<input type="text" name="mobile_no" id="mobile_no" class="form-control"  placeholder="Enter Mobile No" value="<?= isset($_REQUEST["phone"]) ? $_REQUEST["phone"] : ""; ?>" >
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group">
								...
								<select class="form-control i_country select2-show-search form-select" id="i_country" name="i_country" value="<?= $enquiry->intersted_country ?>" data-placeholder="Select Intersted Country">
									<option value=""></option>
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group">
								...
								<select class="form-control select2-show-search form-select visatype" id="visatype" name="visatype" data-placeholder="Select Visa">
...
<script type="text/javascript">
 ...
 $('.repeater').repeater({
	...
	var continue_to = base_url + 'franchise/request';
	function goBack() {
