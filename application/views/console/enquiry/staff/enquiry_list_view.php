        ...
        <form class="follow_up_form">
           ...
           <div class="modal-body">
              <div class="col-sm-12 col-md-12 input-inside mb-1">
                 <label class="form-label"><b>Follow Up Date</b><span class="text-red">*</span></label>
              ...
              <div class="col-sm-12 col-md-12 input-inside mb-1">
                 <label class="form-label"><b>Follow Up Time </b></label>
              ...
              <div class="col-sm-12 col-md-12 input-inside mb-1">
                 ...
                 <select class="form-control select2 form-select" name="enquiry_status" id="enquiry_status" data-placeholder="Choose Status" style="width: 100% !important;">
                    <option value=""></option>
      ...
      <div class="modal-content modal-content-demo">
         <form class="send_whatsup_template_form">
            ...
            <div class="modal-body input-inside">
               ...
               <select class="form-control w_template_id select2-show-search form-select mb-2" id="w_template_id" required style="width:100% !important;">
...
<div class="container-fluid px-3 px-md-4">
    ...
    <div class="col-lg-12 text-center"><b>Missed the advertisement? Refresh the page for <?=$get_offer_count[0]->total?></b></div>
    <!-- <p style="text-align: center;"><span style="position: absolute; margin-top: 34px;margin-left: -93px;">Advertisement Here</span></p> -->
    <a class="" href="<?=$get_offer->link?>" target="_blank"><?php if($get_offer->image) { ?><image src="<?php echo base_url().$get_offer->image ?>" lass="img-fluid" /><?php }?></a>
  </div>
  <br/><br/>
    ...
    <div class="enquiry-right-zone d-flex align-items-center justify-content-center justify-content-md-end">
     ...
     <!--  <button class="box-btn fill_primary" data-bs-toggle="modal" data-bs-target="#enquery">
        ...
        Add Enquiry
             ...
             <a href="javascript;" class="btn box-btn fill_primary pull-right open_my_form_form" data-control="staff/enquiry" data-mathod="add"><i class="fa fa-plus"></i>
              Add Enquiry
            </a>      
    </div>
  </div>
<!-- filter end -->
   ...
   <!-- <div class="card-header">
      ...
      <div class="col-3">
            <a href="javascript;" class="btn btn-info btn-sm pull-right open_my_form_form" data-control="staff/enquiry" data-mathod="add"><i class="fa fa-plus"></i>
              Add Enquiry
            </a>             
         </div>
         <div class="col-2">
            <label class="custom-control custom-checkbox-md pull-right">
        <input type="checkbox" class="custom-control-input display_date_filter" name="display_date_filter" id="display_date_filter">
        <span class="custom-control-label"></span>
        <label for="display_date_filter">Deadline</label>
      </label>
         </div>
         <div class="col-sm-3 col-md-3 display_date_field" style="display:none">
                 <div class="wd-200 mg-b-30">
                    <div class="input-group">
                       <div class="input-group-text">
                          <i class="fa fa-calendar tx-16 lh-0 op-6"></i>
                       </div><input class="form-control select_interview_date pull-right" name="select_interview_date" placeholder="MM/DD/YYYY" type="text" readonly>
                    </div>
                    <span class="interview_date_error_msg text-red"></span>
                 </div>
              </div>  
      ...
      <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content modal-content-demo">
            <form class="send_email_template_form">
               ...
               <div class="modal-body">
                  <div class="alert alert-danger" role="alert" style="    background-color: palevioletred;color: white;">
                     Any One Of The Two Can Be Sent
                  </div>

                  <span class="check_box_empty_error" style="color:red;"></span>

                  <label class="form-label"><b>Template </b></label>
                  <select class="form-control email_template_id select2-show-search form-select" id="email_template_id"  style="width:100%;" data-placeholder="Choose Template">
                     <option value="">Select Template</option>
     ...
     <div class="modal-content modal-content-demo">
        <form class="pool_review_form" id="pool_review_form">
           ...
           <div class="modal-body">
            ...
            <div class="col-sm-12 col-md-12 pool_status_drop mb-2">
             <div class="form-group input-inside">
               <label class="form-label "><b>Pool Status</b></label>
               <select class="form-control pool_status select2" name="pool_status" required>
...
<script>
  ...
  function get_interview_process_pool_data(start,end){
   ...
   $.ajax({
      url : base_url + 'franchise/staff/enquiry/fetch_date_process_pool_data',
      type : "POST",
...
$(document).ready(function() {
 ...
 var continue_to = base_url + 'franchise/staff/enquiry';
