					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group input-inside">
								...
								<input type="email" name="email" id="email" class="form-control" placeholder="Email" value="<?= isset($enquiry->email) && !empty($enquiry->email) ? $enquiry->email : set_value('email'); ?>" disabled>
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group input-inside">
								...
								<input type="text" name="mobile_no" id="mobile_no" class="form-control mobile_no" placeholder="Enter Mobile No" value="<?= isset($enquiry) && !empty($enquiry->mobile_no) ? $enquiry->mobile_no : set_value('mobile_no'); ?>" disabled>
						...
						<div class="col-sm-6 col-md-6 input-inside">
							...
							<div class="wd-200 mg-b-30">
								<div class="input-group">
									...
									<input class="form-control follow_up_date" id="follow_up_date" name="follow_up_date" placeholder="MM/DD/YYYY" type="text"  value="<?= isset($enquiry) && !empty($enquiry->follow_up_date) ? date('m/d/Y',strtotime($enquiry->follow_up_date)) : set_value('follow_up_date'); ?>" autocomplete="off" readonly disabled><br>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12 col-md-12">
							<div class="form-group input-inside">
								...
								<select class="form-select enquiry_type" id="enquiry_type" name="enquiry_type" data-placeholder="Enquiry Type" readonly disabled>
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group input-inside">
								...
								<select class="language form-select" id="language" name="language" disabled>
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group input-inside">
								...
								<select class="form-select s_description select2-show-search form-select" name="s_description" disabled>
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group input-inside">
								...
								<select class="form-select i_country multiple_country" id="i_country" name="" value="<?= $enquiry->intersted_country ?>" data-placeholder="Select Intersted Country" disabled>
									<option value=""></option>
						...
						<div class="col-sm-6 col-md-6 selectvisa" style="display:none;">
							<div class="form-group input-inside">
								...
								<select class="form-control city select2-show-search form-select" id="visatype" name="visatype" data-placeholder="Select Visa" disabled>
						...
						<div class="col-sm-12 col-md-12">
							<div class="form-group input-inside">
								...
								<textarea class="form-control description" name="description" placeholder="Enter Description" readonly><?= isset($enquiry) && !empty($enquiry->description) ? $enquiry->description : set_value('name'); ?></textarea>
							</div>
						</div>
...
var enquiry_staff_id = $('.enquiry_staff_id');
  ...
  i_country.on('select2:open', () => {
		...
		//$('.enquiry_type').select2({disabled:'readonly'});
