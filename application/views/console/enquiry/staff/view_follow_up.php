    <!-- <div class="table-responsive"> -->
      <table class="table table-bordered text-nowrap border-bottom today_follw_up_tbl" id="responsive-datatable" style="width: 100%;">
       <thead>
         <tr>
           <th width="wd-15p border-bottom-0"> Index </th>
           <th width="wd-15p border-bottom-0"> Enquiry Date </th>
