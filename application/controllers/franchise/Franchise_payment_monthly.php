...
class Franchise_payment_monthly extends CI_Controller {
	/**
	...
	public function sendpaymeny()
	{
		...
		//$_SESSION['monthlypayment'] = "yes";

		$data = $this->prepareData($amount,$razorpayOrderId);


		$this->load->view('franchise/globel_setting/monthlyrezorpay',array('data' => $data));
	...
	public function verify()
	{
		...
		try { 
               ...
               $pastdate = $pastdate->payment_date;
                $totaldays = $this->setting_model->dateDiff($pastdate, $currentdate);   
                if($totaldays > 31 && $totalbalance <= MINIMUM_BALANCE){
