               ...
               if(!empty($country_visa)){
                    ...
                    foreach($formdat->formdata as $key=>$fvalue){
                        ...
                        // $url = $actual_link."/"."visaclaptour/apply_visa/visaform/".$country_visa[0]->origin_country."/".$country_visa[0]->destination_country."/".$country_visa[0]->id."/".$country_visa[0]->visa_type_id."/".$linkquery->linkquery->visa_type."/".$franchiseid."/".trim($phonenumber);
                          $url = $actual_link."/"."visaclaptour/apply_visa/newvisaform/".$country_visa[0]->origin_country."/".$country_visa[0]->destination_country."/".$country_visa[0]->id."/".$country_visa[0]->visa_type_id."/".$linkquery->linkquery->visa_type."/".$franchiseid."/".trim($phonenumber)."/".$gpid;
                    ...
                    $html .= "<tr><td><b>".$documentid[0]->name."<b></td><td>";
                     ...
                     if(!empty($linkquery->linkquery)){
                        $franchiseid = $this->session->userdata('user_id');
                         ...
                         $url = $actual_link."/"."visaclaptour/apply_visa/visaform/".$country_visa[0]->origin_country."/".$country_visa[0]->destination_country."/".$country_visa[0]->id."/".$country_visa[0]->visa_type_id."/".$linkquery->linkquery->visa_type."/".$franchiseid.$passing;
